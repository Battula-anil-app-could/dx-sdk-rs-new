use dharitri_sc::codec::test_util::{check_dep_encode_decode, check_top_encode_decode};
...
fn struct_1_to_bytes_writer() {
    ...
    let mut arr: [u8; 16] = [0u8; <Struct1 as dharitri_sc::types::ManagedVecItem>::PAYLOAD_SIZE];

    <Struct1 as dharitri_sc::types::ManagedVecItem>::to_byte_writer(&s, |bytes| {
        arr[0..<Struct1 as dharitri_sc::types::ManagedVecItem>::PAYLOAD_SIZE]
...
fn struct_1_from_bytes_reader() {
    ...
    let struct_from_bytes =
        <Struct1 as dharitri_sc::types::ManagedVecItem>::from_byte_reader(|bytes| {
