...
pub const LAST_VERSION: &str = "0.13.4";
...
pub mod tests {
    ...
    fn template_versions_with_autogenerated_wasm_test() {
        ...
        assert!(!is_template_with_autogenerated_wasm("0.13.1"));
    }

    #[test]
    fn template_versions_with_autogenerated_json_test() {
        assert_eq!(template_versions_with_autogenerated_json()[0], "0.13.1");

        assert!(is_template_with_autogenerated_json("0.13.1"));
        assert!(!is_template_with_autogenerated_json("0.12.5"));
    }
}
