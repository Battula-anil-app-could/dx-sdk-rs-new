...
pub fn upgrade_to_10_9_0(dir: &RelevantDirectory) {
...
pub fn postprocessing_after_10_9_0(dir: &RelevantDirectory) {
    if dir.dir_type != DirectoryType::Contract {
        return;
    }
    print_postprocessing_after_10_9_1(dir.path.as_path());
